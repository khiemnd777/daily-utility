...
await writeFile(
  ...
  [
    ...
    "Safety limits: 25 MB, 200 pages, and 2,000 clickable links per PDF.",
    "",
    "Unrecognized Canva URL formats require manual review. Classification is a QA hint.",
    "It does not verify live URL access, Canva permissions,",
